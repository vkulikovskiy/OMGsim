...
#include "WPropDetectorConstruction.hh"
...
int main(int argc_,char** argv_)
{
  ...
  try {
    ...
    KM3AnalysisManager* analysis = WPropAnalysisManager::getIt();
    ...
    WPropDetectorConstruction* Detector = new WPropDetectorConstruction;
    ...
    runManager->SetUserAction(new WPropSteppingAction);
